          ...
          <Reveal delay={0.1}>
            <div className="rounded-2xl border border-border bg-card/40 p-8 text-muted-foreground leading-relaxed space-y-4">
              ...
              <p className="text-base text-foreground/80">
                This Privacy Policy describes how FMG (a brand of Liantaud Holdings LLC) collects, uses, and protects information from visitors and customers. Full policy text will be added shortly.
              </p>
            </div>
          </Reveal>
        </div>
