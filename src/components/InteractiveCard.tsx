...
export function InteractiveCard({
  ...
  return (
    <Comp
      {...linkProps}
      className={cn(
        "interactive-card group relative block overflow-hidden h-full border border-border transition-colors duration-300 ease-out hover:border-[hsl(var(--primary)/0.4)]",
        className,
      )}
    >
      ...
      <span
        aria-hidden
        className="pointer-events-none absolute top-0 left-0 w-[40%] h-[40%] opacity-0 transition-opacity duration-[400ms] ease-out group-hover:opacity-100"
        style={{
          background:
      ...
      <span
        aria-hidden
        className="ic-accent pointer-events-none absolute bottom-0 left-0 h-[2px] w-full origin-left scale-x-0 bg-[hsl(var(--primary))] transition-transform duration-[400ms] ease-out group-hover:scale-x-100"
      />
